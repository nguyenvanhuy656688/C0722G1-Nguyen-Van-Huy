...
public class StudentService implements IStudentService {
    ...
    public Student infoStudent() throws StudentException {
        ...
        Student student = new Student(code, name, gender, dayBirth, nameClass, score);
        return student;
    }
    ...
    private List<Student> readFile() throws IOException {
        File file = new File("src\\ss16_file\\exercise\\mvc\\data\\student.cvs");
        ...
        while ((line = bufferedReader.readLine())!= null){
            arr = line.split(",");
            studentList.add(new Student(arr[0],arr[1],Boolean.parseBoolean(arr[2]),Integer.parseInt(arr[3]),arr[4],Double.parseDouble(arr[5])));
