...
<nav class="navbar navbar-expand-lg bg-light">
    <div class=" container-fluid" style="background-color: #ffcd39;align-items: center">
        <a class="navbar-brand">Furama Home</a>
                    ...
                    <div class="btn btn-group">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item"
                                   href="http://localhost:63342/modul3/case_study_web/employer/employer.html?_ijt=hr37nimmgv70bd1e24cdgmvob4">Nhân
                                viên</a></li>
                            <li>
...
<section class="navbar d-flex justify-content-center" id="navbar">
    <div class="col-sm-12 col-md-11 ">
        <h2 style="text-align: center">Quản lý Bệnh An</h2>
    </div>
    </div>
    <table id="table" class="table table-bordered" style="text-align: center" border="2">
...
<div style="margin-top: 30px " ; class="footer">
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="col-md-4" ; style="margin-left: 20px">
            ...
            <p style="margin-left: 40px">Khu nghỉ dưỡng Furama là cơ sở hàng đầu để khám phá một trong những điểm đến
                hấp dẫn nhất Châu Á. Chỉ
